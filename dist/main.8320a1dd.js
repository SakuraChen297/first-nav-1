...
var logoA = "<svg class=\"icon\" aria-hidden=\"true\">\n<use xlink:href=\"#icon-bilibili\"></use>\n</svg>";
var logoB = "<svg class=\"icon\" aria-hidden=\"true\">\n<use xlink:href=\"#icon-github\"></use>\n</svg>";
...
$("#addButton").on("click", function () {
  var url = window.prompt("请问您想新增的网站是？");
...
//# sourceMappingURL=main.8320a1dd.js.map